...
# define MAXFILESIZE 2048 //1024  // 2048
...
void DisplayHelp()
{
    ...
    printf("stat : To display information using file name\n");
...
int fstat_file(int fd)
{
    ...
    if(temp->permission == 1)
        ...
        printf("File permission is : write only\n");  
    else if(temp->permission == 3)
        printf("File permission is : Read & Write only\n");    
    printf("----------------------------------------------\n\n");
